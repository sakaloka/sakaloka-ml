...
# Load model & encoders
model = tf.keras.models.load_model("D://CODING-CAMP CAPSTONE//Model Rating Based//recommender_model")
user_encoder = joblib.load("D://CODING-CAMP CAPSTONE//Model Rating Based//user_encoder.pkl")
place_encoder = joblib.load("D://CODING-CAMP CAPSTONE//Model Rating Based//place_encoder.pkl")

place_df = pd.read_csv("D://CODING-CAMP CAPSTONE//Model Rating Based//places.csv")  
